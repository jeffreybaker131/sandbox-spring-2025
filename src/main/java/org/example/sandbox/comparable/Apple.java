...
public class Apple extends Fruit implements Comparable<Fruit> {
    ...
    public String toString() {
        ...
        sb.append("Apple{").append("name='").append(name).append('\'').append(", color='").append(color).append('\'')
                .append(", weight=").append(weight).append(", variety='").append(variety).append('\'').append('}');
        return sb.toString();
